...
ConVar hl2_walkspeed( "hl2_walkspeed", "190" );
ConVar hl2_normspeed( "hl2_normspeed", "255" );
ConVar hl2_sprintspeed( "hl2_sprintspeed", "500" );
...
void CHL2_Player::Precache( void )
{
	...
	PrecacheScriptSound("plr.letsdoit");
	PrecacheScriptSound("plr.lifeispain");
...
void CHL2_Player::Spawn(void)
{
	...
	EmitSound( filter, entindex(), "plr.letsdoit" );
}
